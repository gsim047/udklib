...
//		$smallimg = imageCreateFromJpeg(dirname(__FILE__)."/th$sz.jpg");
		$smallimg = imageCreateFromJpeg(thumbSampleDir()."th$sz.jpg");
...
// start
	...
	// www path,  e g "/scan"
	$wwwdir = wwwDir(); //"/scan_";
	// the same fs path,  e g "/var/www/html/scan"
	$basedir = fsDir(); //dirname(__FILE__); //.$wwwdir;

	dd("wwwdir:$wwwdir basedir:$basedir");
	...
	$path = $basedir."/".$dir;  // "/scan/scan"
	$pathw = $wwwdir."/".$dir;  // "/var/www/html/scan/scan"
	dd("path:$path pathw:$pathw");
